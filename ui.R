...
crime_types <- c(animal, assault, burglary, counterfeit, dispute, disturbance, dui, 
                 embezzle, false_report, forgery_check, fraud, harassment, homicide,
                 injury, liquor_law, malicious_harassment, narcotics, obstruct, 
                 property_damage, prostitution, reckless_burning, robbery, theft,
                 viol_court, warrant, weapon)
